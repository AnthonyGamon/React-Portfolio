...
export declare const useToggleBodyClass: (bool: boolean, [on, off]: [string, string]) => void;
...
export declare const useGoogleAnalytics: (id: string, startLoading: boolean) => void;
...
export declare const useOnPageLoad: () => boolean;
declare type UseScript = {
    startLoading: boolean;
    src: string;
};
export declare const useLoadScript: ({ startLoading, src }: UseScript) => {
    ready: boolean;
    error: string | null | Event;
};
export declare const useScript: (props: UseScript) => {
    ready: boolean;
    error: string | null | Event;
};
export declare const useDelay: (ms: number) => boolean;
export {};
